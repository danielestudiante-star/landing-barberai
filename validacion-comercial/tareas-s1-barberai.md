...
| Tarea | Estado | Responsable | Evidencia requerida | Nota |
| --- | --- | --- | --- | --- |
| Resolver Backlog del miercoles. | Pendiente | Daniel | Backlog actualizado. | Backlog primero. |
| Preparar 3 artes estilo Simplexity: feed 1080x1080, story 1080x1920 y concepto de video. | Pendiente | Daniel | Archivos o brief de artes. | No creados aun. |
| Crear 5 guiones de TikTok para BarberAI. | Pendiente | Daniel | Documento de guiones. | Puede salir del calendario. |
...
| Tarea | Estado | Responsable | Evidencia requerida | Nota |
| --- | --- | --- | --- | --- |
| Backlog en 0 antes de seguir. | Pendiente | Daniel | `backlog-barberai.md` sin tareas abiertas. | Regla obligatoria. |
