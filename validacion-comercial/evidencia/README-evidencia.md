...
| --- | --- |
| `01-home-deploy.png` | Pagina principal del deploy cargando correctamente. |
| `02-chatbot-abierto.png` | Chatbot abierto en el deploy. |
| `03-chatbot-respuesta.png` | Una pregunta real al chatbot y su respuesta sobre citas, servicios u horarios. |
